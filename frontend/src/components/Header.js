    ...
    <header className="header" ref={headerRef}>
      <div className="header-container gbx-hd">
        ...
        <div className="gbx-hd-user">
          ...
          <div className="user-menu" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
              ...
              >
                ...
                {/* Appearance toggle (dashboard: lives here in the menu) */}
                <button
                  onClick={() => toggleTheme()}
                  className="menu-option"
                  role="menuitem"
          ...
          {isSpectator && (
            <>
              <button type="button" onClick={() => toggleTheme()} className="gbx-hd-iconbtn gbx-hd-toggle" title={theme === 'dark' ? 'Switch to light theme' : 'Switch to dark theme'} aria-label="Toggle theme">
                {theme === 'dark' ? (
              ...
              <a href="/" className="gbx-hd-iconbtn gbx-hd-toggle gbx-hd-home" title="Home" aria-label="Go to home">
