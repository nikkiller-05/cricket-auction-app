  ...
  return (
    <div className="gbx-reset-controls bg-white bg-opacity-20 rounded-xl shadow-2xl p-6 hover:bg-opacity-30 transition-all duration-300">
      ...
      <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="text-center p-3 bg-gray-50 rounded-lg shadow-md">
        ...
        <div className="text-center p-3 bg-green-50 rounded-lg shadow-md">
        ...
        <div className="text-center p-3 bg-red-50 rounded-lg shadow-md">
