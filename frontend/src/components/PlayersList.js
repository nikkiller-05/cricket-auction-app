                          ...
                          {canConfigure && (
                            <>
                              <button
                                ...
                                className="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-amber-400/30 bg-amber-400/15 text-amber-600 hover:bg-amber-400/25 hover:-translate-y-0.5 active:translate-y-0 transition"
                              >
                              ...
                              <button
                                ...
                                className="inline-flex items-center justify-center w-8 h-8 rounded-lg border border-rose-500/30 bg-rose-500/15 text-rose-600 hover:bg-rose-500/25 hover:-translate-y-0.5 active:translate-y-0 transition"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
