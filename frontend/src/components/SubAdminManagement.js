  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-xl font-semibold text-gray-900">Sub-Admin Management</h3>
        <button
      ...
      {showCreateForm && (
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Create New Sub-Admin</h4>
          <form onSubmit={handleCreateSubAdmin} className="space-y-4">
            ...
            <div className="flex space-x-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white py-2 px-4 rounded-md"
              >
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="px-6 py-4 border-b border-gray-200">
          <h4 className="text-lg font-medium text-gray-900">Active Sub-Admins ({subAdmins.length})</h4>
        </div>
          ...
          <div className="divide-y divide-gray-200">
            {subAdmins.map((admin) => (
              <div key={admin.id} className="px-6 py-4 flex items-center justify-between">
                <div>
                  <h5 className="font-medium text-gray-900">{admin.name || admin.username}</h5>
